...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Desktop Full HD (1920x1080) >> Module Cài đặt hệ thống - Hiển thị đúng trên Desktop Full HD
