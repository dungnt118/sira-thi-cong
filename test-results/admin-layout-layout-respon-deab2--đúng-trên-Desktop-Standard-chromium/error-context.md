...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Desktop Standard (1280x720) >> Module Báo cáo - Hiển thị đúng trên Desktop Standard
- Location: test\e2e\admin-layout\layout-responsive.spec.ts:32:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/admin/reports
Call log:
  - navigating to "http://localhost:5173/admin/reports", waiting until "load"
