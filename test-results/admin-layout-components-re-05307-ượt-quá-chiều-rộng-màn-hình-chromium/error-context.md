...
- Name: admin-layout\components-responsive.spec.ts >> Kiểm tra Thành phần UI Responsive >> Màn hình: Desktop >> Modal thêm người dùng không vượt quá chiều rộng màn hình
- Location: test\e2e\admin-layout\components-responsive.spec.ts:48:7
