...
- Name: admin-layout\components-responsive.spec.ts >> Kiểm tra Thành phần UI Responsive >> Màn hình: Mobile >> Quản lý người dùng - Card thống kê xếp chồng trên mobile
