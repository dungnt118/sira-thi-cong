...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Tablet Landscape (1024x768) >> Module Dashboard - Hiển thị đúng trên Tablet Landscape
