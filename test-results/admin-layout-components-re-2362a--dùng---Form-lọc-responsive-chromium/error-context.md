...
- Name: admin-layout\components-responsive.spec.ts >> Kiểm tra Thành phần UI Responsive >> Màn hình: Desktop >> Quản lý người dùng - Form lọc responsive
- Location: test\e2e\admin-layout\components-responsive.spec.ts:38:7
