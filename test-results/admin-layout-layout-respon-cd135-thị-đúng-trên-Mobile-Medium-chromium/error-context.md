...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Mobile Medium (390x844) >> Module Nhật ký hệ thống - Hiển thị đúng trên Mobile Medium
