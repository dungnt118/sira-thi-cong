...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Desktop Standard (1280x720) >> Module Cài đặt hệ thống - Hiển thị đúng trên Desktop Standard
