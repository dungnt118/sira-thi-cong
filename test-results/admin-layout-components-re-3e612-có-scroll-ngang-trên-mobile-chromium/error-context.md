...
- Name: admin-layout\components-responsive.spec.ts >> Kiểm tra Thành phần UI Responsive >> Màn hình: Desktop >> Quản lý người dùng - Bảng dữ liệu có scroll ngang trên mobile
