...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Tablet Landscape (1024x768) >> Module Quản lý quyền - Hiển thị đúng trên Tablet Landscape
- Location: test\e2e\admin-layout\layout-responsive.spec.ts:32:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/admin/roles
Call log:
  - navigating to "http://localhost:5173/admin/roles", waiting until "load"
