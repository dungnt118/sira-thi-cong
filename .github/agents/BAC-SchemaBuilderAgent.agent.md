...
tools: [execute, read, agent, bac/content-create, bac/content-create_many, bac/content-get, bac/content-search, bac/content-update_by_ids, bac/graphql_inspector-list_admin_schema_operations, bac/graphql_inspector-list_admin_schema_types, bac/graphql_inspector-list_app_schema_operations, bac/graphql_inspector-list_app_schema_types, bac/graphql_inspector-list_available_schemas, bac/menu_mng-update_positions, bac/schema-batch_create_or_update_property, bac/schema-create, bac/schema-get, bac/schema-get_relationships, bac/schema-list, bac/schema-list_tag_groups, bac/schema-re_layout_form, bac/schema-re_layout_nested_form, bac/schema-search, bac/schema-update_deprecated_properties, bac/schema-update_nested_property, bac/schema-update_prop_client_rules, bac/schema-update_triggers, bac/menu_mng-get, bac/menu_mng-get_tree, bac/menu_mng-list, bac/menu_mng-delete, bac/menu_mng-update, bac/schema-depended_schemas-update, bac/menu_mng-create, bac/content-describe-schema]
---
