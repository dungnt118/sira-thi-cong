...
tools: [execute, read, agent, bac/content-create, bac/content-create_many, bac/content-delete, bac/content-get, bac/js_library-get_function_usage_example, bac/js_library-list_api_namespaces, bac/schema-batch_create_or_update_property, bac/schema-create, bac/schema-update_deprecated_properties, bac/schema-update_nested_property, bac/content-describe-schema, bac/content-save_setting, bac/content-search, bac/content-update_by_ids, bac/graphql_inspector-list_admin_schema_operations, bac/graphql_inspector-list_admin_schema_types, bac/graphql_inspector-list_app_schema_operations, bac/graphql_inspector-list_app_schema_types, bac/graphql_inspector-list_available_schemas, bac/js_library-get_api_model, bac/js_library-get_api_model_usage, bac/js_library-get_method_signature, bac/js_library-search_functions, bac/js_library-validate_api_model_script, bac/menu_mng-create, bac/menu_mng-delete, bac/menu_mng-get, bac/menu_mng-get_tree, bac/menu_mng-list, bac/menu_mng-update, bac/menu_mng-update_positions, bac/openapi_explorer-search, bac/schema-depended_schemas-update, bac/schema-get, bac/schema-get_relationships, bac/schema-get_trigger_script_guide, bac/schema-list, bac/schema-list_tag_groups, bac/schema-re_layout_form, bac/schema-re_layout_nested_form, bac/schema-search, bac/schema-set_trigger_script, bac/schema-update_prop_client_rules, bac/schema-update_triggers, bac/schema-validate_trigger_script, bac/appmodule-create, bac/appmodule-get, bac/appmodule-list, bac/appmodule-update, bac/js_library-create_api_model, bac/js_library-update_api_model]
---
