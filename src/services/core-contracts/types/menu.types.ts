...
/**
 * Menu interface
 * Auto-generated from Schema: Menu
 */
export interface IMenu {
  ...
  moduleIds?: any[];
  panel_type?: MenuPanelTypeEnum;
  url_type?: MenuUrlTypeEnum;
  layoutId?: string;
...
export interface ICreateMenuInput {
  ...
  target_schema?: string;
  moduleIds?: any[];
  panel_type?: MenuPanelTypeEnum2;
  url_type?: MenuUrlTypeEnum2;
  layoutId?: string;
  viewExtensionId?: string;
  requiredPermissions?: any[];
  isDefault?: any[];
...
export type IMenuListResponse = ApiListResponse<IMenu>

// Union types generated from value_options
export type MenuPanelTypeEnum = 'UNDEFINED' | 'CUSTOMPAGE' | 'LAYOUT' | 'REPORTDASHBOARD' | 'VIEW' | 'FORM' | 'REPORT' | 'MENU' | 'SCHEMA' | 'MICROAPP' | 'SMARTLAYOUT' | 'TIMELINEFLOW';
export type MenuUrlTypeEnum = 'Layout' | 'Schema' | 'SinglePage' | 'Personal' | 'Custom' | 'SchemaViewExt';
export type MenuTypeEnum = 'item' | 'item_group' | 'tab' | 'controller' | 'link' | 'group' | 'collapse' | 'button';
...
export type MenuPanelTypeEnum2 = 'UNDEFINED' | 'CUSTOMPAGE' | 'LAYOUT' | 'REPORTDASHBOARD' | 'VIEW' | 'FORM' | 'REPORT' | 'MENU' | 'SCHEMA' | 'MICROAPP' | 'SMARTLAYOUT' | 'TIMELINEFLOW';
export type MenuUrlTypeEnum2 = 'Layout' | 'Schema' | 'SinglePage' | 'Personal' | 'Custom' | 'SchemaViewExt';
export type MenuTypeEnum2 = 'item' | 'item_group' | 'tab' | 'controller' | 'link' | 'group' | 'collapse' | 'button';
