    ...
    if (!customer) {
        return (
            <Card style={{ marginTop: 40, textAlign: 'center', borderRadius: 20 }}>
                ...
                <Button onClick={() => navigate('/sale/customers')}>Quay lại danh sách khách hàng</Button>
            </Card>
        );
    }
    ...
    const journeyColumns: ColumnsType<IJourney> = [
        {
            ...
            render: (value: string, journey) => (
                <Button type="link" style={{ padding: 0 }} onClick={() => navigate(`/sale/dashboard/${journey._id}`)}>
                    {value}
                </Button>
            ),
        },
                        ...
                        <Card bordered={false} style={{ borderRadius: 18 }}>
                            <Space direction="vertical" style={{ width: '100%' }}>
                                <Button
                                    ...
                                    onClick={() => navigate(`/sale/dashboard?customerId=${customerId}`)}
                                >
                                    Tạo yêu cầu dịch vụ
                                </Button>
