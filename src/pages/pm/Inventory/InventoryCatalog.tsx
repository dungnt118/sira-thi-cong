    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
                ...
                <Space>
                    <Button onClick={() => navigate('/pm/inventory/request-out')}>📤 Yêu cầu Xuất kho</Button>
                    <Button type="primary" onClick={() => navigate('/pm/inventory/request-in')}>📥 Yêu cầu Nhập kho</Button>
                </Space>
            </div>
                    ...
                    message={
                        <span>
                            ...
                            {' '}<Button size="small" type="link" icon={<ArrowRightOutlined />}
                                onClick={() => navigate('/pm/inventory/request-in')}>
