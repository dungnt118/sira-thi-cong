...
export const Step01Info: React.FC<Step01InfoProps> = ({ isEditable = false, onSave }) => {
    ...
    if (!isEditable) {
        return (
            <Card title="Chi tiết bước: Thông tin khách hàng (Sale)" bordered={false} className="ky-card">
                <Result
                    status="info"
                    title="Thông tin khách hàng"
                    subTitle="Thông tin chi tiết của bước Thông tin khách hàng ở chế độ xem (Readonly)."
                />
            </Card>
        );
    }
    ...
    return (
        <Card title="Thực hiện: Thông tin khách hàng" bordered={false} className="ky-card">
