import type {
    ...
    PaymentMilestone, WarrantyCard, WarrantyReminder, User, StockRequest, Pipeline
} from '../types/v3';
...
export const mockStockOrders: StockOrder[] = [
    {
        ...
        totalValue: 18350000, status: 'SIGNED',
    ...
    },
    {
        ...
        totalValue: 16350000, status: 'SIGNED',
