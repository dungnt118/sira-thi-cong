...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Desktop Large (1440x900) >> Module Cài đặt hệ thống - Hiển thị đúng trên Desktop Large
