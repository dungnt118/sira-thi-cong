...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Tablet Portrait (768x1024) >> Module Quản lý người dùng - Hiển thị đúng trên Tablet Portrait
