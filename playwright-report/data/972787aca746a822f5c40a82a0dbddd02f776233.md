...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Mobile Android (360x800) >> Module Quản lý người dùng - Hiển thị đúng trên Mobile Android
