...
- Name: admin-layout\components-responsive.spec.ts >> Kiểm tra Thành phần UI Responsive >> Màn hình: Desktop >> Quản lý người dùng - Card thống kê xếp chồng trên mobile
- Location: test\e2e\admin-layout\components-responsive.spec.ts:26:7
