...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Mobile Narrow (320x568) >> Module Dashboard - Hiển thị đúng trên Mobile Narrow
