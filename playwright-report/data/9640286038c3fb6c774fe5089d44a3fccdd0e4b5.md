...
- Name: admin-layout\layout-responsive.spec.ts >> Kiểm tra Responsive Layout Quản lý (AdminLayoutV2) >> Màn hình: Mobile Large (414x896) >> Module Quản lý người dùng - Hiển thị đúng trên Mobile Large
